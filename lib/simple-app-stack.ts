...
export class SimpleAppStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps){
    ...
    const getAllMovciesFnURL = getAllMoviesFn.addFunctionUrl({
      authType: lambda.FunctionUrlAuthType.NONE,
      cors: {
        allowedOrigins: ["*"],
      },
    ...
    new cdk.CfnOutput(this, "Get All Movies Function URL", { value: getAllMovciesFnURL.url});
